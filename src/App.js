      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg p-5 max-w-3xl items-center">
          ...
          <div className="md:w-1/2 px-16">
            <h2 className="font-bold text-2xl text-[#02428F]">Login</h2>
            <p className="text-sm mt-4 text-[#02428F]">
            ...
            <form action="" className="flex flex-col gap-4">
              ...
              <button className="bg-[#02428F] rounded-xl text-white py-2 hover:scale-105 duration-300">
                Log In
              </button>
            </form>
